        ...
        <div className=" w-full flex flex-col">
          ...
          <div className=" flex gap-x-2 h-[36px] text-sm">
            ...
            <div className="flex flex-1 max-w-[100px] items-center h-full border text-primary font-medium ">
              ...
              {amount}</div>
              <div onClick={()=>increase(id)} className="flex-1  h-full flex justify-center items-center cursor-pointer"> 
              <IoMdAddCircle/> </div>
          
            </div>
            <div className="flex-1 flex  justify-end items-center text-primary font-medium">{`R ${(price * amount).toFixed(2)} `}</div>
          </div>
        </div>
      </div>
    </div>
